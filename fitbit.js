...
(function() {
  var FitbitActivities, FitbitBody, FitbitFoods, getBodyFat, getBodyFatGoal, getBodyWeight, getBodyWeightGoal, getFoodData, handleBodyData, kilosToPounds, roundToNearestTwo, session, setSession;
  ...
  getFoodData = function(response) {
    var date, getActivitiesChoreo, getActivitiesInputs, getFoodsChoreo, getFoodsInputs, today;
    ...
    return getFoodsChoreo.execute(getFoodsInputs, (function(results) {
      return getActivitiesChoreo.execute(getActivitiesInputs, (function(results2) {
        console.log(results2.get_Response());
        return response.render("calories", {
          caloriesIn: JSON.parse(results.get_Response()),
          caloriesOut: JSON.parse(results2.get_Response())
        });
      }), function(error2) {
