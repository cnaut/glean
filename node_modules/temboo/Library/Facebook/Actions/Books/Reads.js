...
var CreateReadingInputSet = function() {
    CreateReadingInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ExplicityShared input for this Choreo. ((optional, boolean) Indicates that the user is explicitly sharing this action. Requires the explicitly_shared capability to be enabled.)
        */
