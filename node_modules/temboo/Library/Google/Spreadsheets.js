...
var RetrieveWorksheetInputSet = function() {
    RetrieveWorksheetInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the SpreadsheetKey input for this Choreo. ((required, string) The unique for key for the spreadsheet associated with the worksheet you want to retrieve. Required unless SpreadsheetName and WorksheetName are supplied.)
        */
        this.set_SpreadsheetKey = function(value) {
            this.setInput("SpreadsheetKey", value);
        }
        ...
        /*
        Set the value of the SpreadsheetName input for this Choreo. ((optional, string) The name of the spreadsheet to retrieve. This and WorksheetName can be used as an alternative to SpreadsheetKey and WorksheetId, but performing a lookup by name will slow down the request.)
        */
        this.set_SpreadsheetName = function(value) {
            this.setInput("SpreadsheetName", value);
        }
        ...
        */
        ...
        /*
        Set the value of the WorksheetName input for this Choreo. ((optional, string) The name of the worksheet to retrieve. This and SpreadsheetName can be used as an alternative to SpreadsheetKey and WorksheetId, but performing a lookup by name will slow down the request.)
        */
